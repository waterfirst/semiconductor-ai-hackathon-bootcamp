...
test('explore companies in the semiconductor and display dual galaxy', async ({ page }, testInfo) => {
  ...
  await expect(page.getByLabel('반도체와 디스플레이 산업 3D 지식맵')).toContainText('9 / 58 COMPANIES')
  ...
  await expect(page.getByLabel('반도체와 디스플레이 산업 3D 지식맵')).toContainText('6 / 58 COMPANIES')
  ...
  await expect(page.getByLabel('반도체와 디스플레이 산업 3D 지식맵')).toContainText('7 / 58 COMPANIES')
  await page.getByLabel('본사 지역').selectOption('us')
  await expect(page.getByLabel('반도체와 디스플레이 산업 3D 지식맵')).toContainText('20 / 58 COMPANIES')
  await page.getByLabel('본사 지역').selectOption('europe')
  await expect(page.getByLabel('반도체와 디스플레이 산업 3D 지식맵')).toContainText('10 / 58 COMPANIES')
  expect(errors).toEqual([])
})
