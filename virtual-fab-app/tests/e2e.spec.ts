...
test('explore companies in the semiconductor and display dual galaxy', async ({ page }, testInfo) => {
  ...
  await expect(page.getByText('대형·핵심 회사명만 표시')).toBeVisible()
  ...
  await page.getByRole('button', { name: 'Samsung Electronics 상세보고서 열기' }).click()
  ...
  await page.getByRole('button', { name: 'Micron 상세보고서 열기' }).click()
