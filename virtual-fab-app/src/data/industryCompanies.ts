...
const DISPLAY_COMPANY_IDS = new Set([
  ...
  'lx-semicon', 'duksan-neolux', 'icd', 'hb-solution', 'idemitsu-kosan', 'nippon-electric-glass',
  'innox-advanced-materials',
])
const SHARED_COMPANY_IDS = new Set([
  'applied-materials', 'screen', 'ulvac', 'semes', 'merck-electronics', 'aixtron',
  'dongjin-semichem', 'soulbrain', 'enf-technology', 'jusung-engineering', 'sfa-engineering',
  'dms', 'nikon', 'agc', 'sumitomo-chemical', 'samsung-sdi',
])
...
const COMPANY_LAYERS: Record<ValueLayerId, string[]> = {
  foundations: ['synopsys', 'cadence', 'arm', 'zeiss', 'shinetsu', 'sumco', 'jsr', 'tok', 'entegris', 'air-liquide', 'sk-siltron', 'duksan-neolux', 'soitec', 'merck-electronics', 'dongjin-semichem', 'soulbrain', 'enf-technology', 'agc', 'sumitomo-chemical', 'samsung-sdi', 'idemitsu-kosan', 'nippon-electric-glass', 'innox-advanced-materials'],
  equipment: ['asml', 'applied-materials', 'lam', 'tel', 'kla', 'asm', 'screen', 'kokusai', 'axcelis', 'semes', 'naura', 'amec', 'onto-innovation', 'aixtron', 'jusung-engineering', 'sfa-engineering', 'dms', 'nikon', 'icd', 'hb-solution'],
...
export const VERIFIED_RELATIONS: IndustryRelation[] = [
  ...
  {
    from: 'dongjin-semichem', to: 'boe', kind: 'supply', strength: 4,
    label: '중국 LCD·OLED 공정 화학소재 공급',
    evidence: 'Dongjin Semichem은 중국 현지 생산법인을 BOE의 direct material supplier이자 strategic partner로 소개한다. 품목은 stripper·etchant·thinner·LCD photoresist이며 거래금액 비중은 공개하지 않았다.',
    asOf: '2026-08-23',
    source: 'https://www.dongjin.com/en/company/be_overseas.php',
  },
  {
    from: 'dongjin-semichem', to: 'tcl-csot', kind: 'supply', strength: 3,
    label: '중국 패널 공정 화학소재 공급',
    evidence: 'Dongjin Semichem은 Huizhou 법인이 CSOT를 포함한 LCD·OLED·반도체 제조사에 공정 화학소재를 공급한다고 공개했다. 거래규모는 비공개다.',
    asOf: '2026-08-23',
    source: 'https://www.dongjin.com/en/company/be_overseas.php',
  },
  {
    from: 'dongjin-semichem', to: 'lg-display', kind: 'supply', strength: 3,
    label: '광저우 패널 공정 화학소재 공급',
    evidence: 'Dongjin Semichem은 Huizhou 법인의 LCD·OLED 공정 화학소재 고객에 Guangzhou LG Display를 명시했다. 거래규모와 현재 품목별 비중은 공개하지 않았다.',
    asOf: '2026-08-23',
    source: 'https://www.dongjin.com/en/company/be_overseas.php',
  },
  {
...
export const INDUSTRY_COMPANIES: IndustryCompany[] = [
  ...
  { id: 'dongjin-semichem', name: 'Dongjin Semichem', country: 'South Korea', category: 'materials', hub: 'materials', status: 'profile', role: '반도체·디스플레이 감광·습식 공정소재', summary: '반도체 PR·BARC·SOC·CMP slurry와 디스플레이 PR·stripper·etchant·color resist를 함께 공급하는 국내 대표 공통 소재기업.', products: ['Semiconductor photoresist·BARC·SOC', 'CMP slurry·Thinner', 'Display PR·Stripper·Etchant', 'Color resist·Organic insulator'], processes: ['PHOTO MATERIAL', 'CMP', 'DISPLAY TFT PATTERN', 'COLOR FILTER'], jobs: ['Polymer·Fine chemistry', 'Photo application', 'Wet chemical quality', 'Customer qualification'], risks: ['고객 인증기간', '원료·수출규제', 'LCD 구조조정과 OLED 소재 전환'], sources: [{ label: 'Dongjin 반도체 소재', url: 'https://www.dongjin.com/en/business/semiconductor.php' }, { label: 'Dongjin 디스플레이 소재', url: 'https://www.dongjin.com/business/display.php' }] },
  { id: 'soulbrain', name: 'Soulbrain', country: 'South Korea', category: 'materials', hub: 'materials', status: 'profile', role: '반도체 고순도 화학·OLED/LCD 소재', summary: '반도체 etchant·cleaner·CMP·precursor와 디스플레이 배선 식각액·OLED 유기재료·thin glass 공정을 잇는 전자재료 기업.', products: ['Semiconductor etchant·Cleaner', 'CMP slurry·CVD/ALD precursor', 'Display Cu·ITO·BOE etchant', 'OLED organic material·Thin glass'], processes: ['ETCH·CLEAN', 'CMP·DEPOSITION MATERIAL', 'DISPLAY WET ETCH', 'OLED CELL·INKJET'], jobs: ['Chemical process', 'Precursor·Organic material', 'Glass slimming', 'Quality·EHS'], risks: ['고순도 원료', '고객별 formulation', '화학물질 안전·환경규제'], sources: [{ label: 'Soulbrain 디스플레이 소재', url: 'https://www.soulbrain.co.kr/en/m22.php' }, { label: 'Soulbrain Group 2024 Sustainability Report', url: 'https://www.soulbrainholdings.co.kr/data/down/Soulbrain%20Group_SUSTAINABILITY%20REPORT%202024%28ENG%29.pdf' }] },
  { id: 'enf-technology', name: 'ENF Technology', country: 'South Korea', category: 'materials', hub: 'materials', status: 'profile', role: '반도체·디스플레이 프로세스 케미컬', summary: '반도체와 디스플레이의 식각·박리·세정·현상·thinner 및 PR 원료, LCD·wOLED color paste를 공급하는 공통 화학소재 기업.', products: ['HF·BOE·Stripper·Thinner', 'OLED cleaner·Display etchant', 'PR monomer·PAG·Polymer', 'LCD·wOLED color paste'], processes: ['WET ETCH', 'STRIP·CLEAN', 'PHOTO CHEMICAL', 'COLOR FILTER'], jobs: ['Formulation·Purification', 'Fine chemistry', 'Recycle process', 'Application·Quality'], risks: ['원료 가격·조달', '화학물질 규제', '고객·공정별 qualification'], sources: [{ label: 'ENF Process Chemical', url: 'https://www.enftech.com/en/business/process-chemical/' }, { label: 'ENF 제품 포트폴리오', url: 'https://www.enftech.com/en/business/product/' }] },
  { id: 'jusung-engineering', name: 'JUSUNG Engineering', country: 'South Korea', category: 'equipment', hub: 'materialsEngineering', status: 'profile', role: '반도체 ALD/CVD·디스플레이 TFT/봉지 장비', summary: '반도체 ALD·CVD와 OLED/LCD TFT용 PECVD·MOALD, OLED 봉지용 ALD/CVD hybrid 장비를 함께 개발하는 공통 증착장비 기업.', products: ['Semiconductor ALD·CVD', '6G·8G TFT MOALD/PECVD', 'OLED Encapsulation ALD/CVD', 'TSP deposition'], processes: ['SEMICONDUCTOR DEPOSITION', 'TFT BACKPLANE', 'OLED ENCAPSULATION', 'THIN FILM'], jobs: ['Plasma·Thin film', 'Chamber·Gas flow', 'Control software', 'Field application'], risks: ['고객 투자 편중', '장비 양산인증', '대면적 균일도·막질 경쟁'], sources: [{ label: 'JUSUNG 디스플레이 장비', url: 'https://jusung.com/document/display' }, { label: 'JUSUNG 1Q25 Fact Sheet', url: 'https://jusung.com/uploads/post/2025/07/adc14fd193ddefeca4ade21b61e435ce.pdf' }] },
  { id: 'sfa-engineering', name: 'SFA Engineering', country: 'South Korea', category: 'equipment', hub: 'materialsEngineering', status: 'profile', role: '클린 물류·OLED 공정·검사 자동화', summary: '반도체·OLED/LCD 클린 물류와 OLED 증착·봉지·inkjet·laser·lamination 장비, AI 검사 시스템을 통합하는 스마트팩토리 기업.', products: ['Clean MHS·OHT·Stocker', 'OLED Evaporator·Encapsulation', 'Inkjet·Vacuum laser', 'Laminator·Inspection'], processes: ['CLEAN FACTORY LOGISTICS', 'OLED DEPOSITION', 'CELL·MODULE', 'SMART FACTORY'], jobs: ['Automation·Control', 'Mechanical·Vacuum', 'Vision·AI inspection', 'System engineering'], risks: ['프로젝트 매출 변동', '대형 고객 CapEx', '설치·통합 일정 리스크'], sources: [{ label: 'SFA 사업부 소개', url: 'https://www.sfa.co.kr/company03' }, { label: 'SFA Display 장비 브로슈어', url: 'https://www.sfa.co.kr/wp-content/uploads/2021/01/0915_SFA_Brochure_full_Korean_01.pdf' }] },
  { id: 'dms', name: 'DMS', country: 'South Korea', category: 'equipment', hub: 'materialsEngineering', status: 'profile', role: '디스플레이 습식장비·반도체 유리기판 공정', summary: 'OLED/LCD glass의 세정·wet etch·strip·PI coat 장비와 차세대 반도체 TGV 유리기판 wet 공정을 연결한다.', products: ['Pre-deposition·Pre-photo cleaner', 'Wet etcher·Stripper', 'PI coater', 'TGV glass wet equipment'], processes: ['DISPLAY CLEAN', 'WET ETCH·STRIP', 'FLEXIBLE OLED PI', 'TGV SUBSTRATE'], jobs: ['Wet process', 'Chemical recycle', 'Mechanical·Control', 'Field service'], risks: ['디스플레이 투자 사이클', '중국 장비 경쟁', 'chemical 균일도·재활용 효율'], sources: [{ label: 'DMS 사업영역', url: 'https://dms21.co.kr/en/index.asp' }, { label: 'DMS OLED·LCD 장비', url: 'https://dms21.co.kr/en/sub/business/display/oled_lcd.asp' }] },
  { id: 'nikon', name: 'Nikon Precision', country: 'Japan', category: 'equipment', hub: 'lithography', status: 'profile', role: '반도체·FPD 노광 장비', summary: '실리콘 wafer용 semiconductor lithography와 대면적 glass TFT 회로용 FPD scanner를 함께 공급하는 공통 정밀장비 기업.', products: ['ArF·KrF·i-line scanner', 'FPD multi-lens scanner', 'OLED·LCD FPD lithography', 'Panel digital lithography'], processes: ['SEMICONDUCTOR PHOTO', 'TFT BACKPLANE PHOTO', 'OVERLAY', 'PANEL PACKAGING'], jobs: ['Optics', 'Stage·Mechatronics', 'Alignment·Control', 'Field service'], risks: ['EUV 부재', '중국 FPD 투자', '초정밀 공급망·설치기반 경쟁'], sources: [{ label: 'Nikon Precision Equipment', url: 'https://www.nikon.com/company/corporate/businesses/precision/' }, { label: 'Nikon FPD 기술', url: 'https://www.nikon.com/business/fpd/technology/' }] },
  { id: 'agc', name: 'AGC', country: 'Japan', category: 'materials', hub: 'materials', status: 'profile', role: '디스플레이 유리·반도체 전자재료', summary: 'TFT-LCD/OLED용 대면적 glass와 EUV mask blank·합성석영·SiC 부품·CMP slurry 등 반도체 소재를 함께 공급한다.', products: ['TFT-LCD·OLED glass', 'EUV photomask blank', 'Synthetic fused silica', 'SiC jig·CMP slurry'], processes: ['DISPLAY SUBSTRATE', 'PHOTOMASK', 'SEMICONDUCTOR OPTICS', 'CMP'], jobs: ['Glass composition', 'Surface·Metrology', 'Electronic materials', 'Manufacturing quality'], risks: ['디스플레이 판가·가동률', '에너지 비용', '대형 glass 현지 생산'], sources: [{ label: 'AGC Display', url: 'https://www.agc.com/en/products/display/index.html' }, { label: 'AGC 2025 Report', url: 'https://www.agc.com/en/company/agc_report/pdf/agc_report_en_2025.pdf' }] },
  { id: 'sumitomo-chemical', name: 'Sumitomo Chemical', country: 'Japan', category: 'materials', hub: 'materials', status: 'profile', role: '디스플레이 광학·OLED와 반도체 감광재', summary: 'LCD/OLED polarizer·touch·OLED 발광/PI·QD/color 재료와 semiconductor photoresist를 함께 보유한 공통 기능성 소재기업.', products: ['Display polarizing film', 'OLED emitting·PI materials', 'QD ink·Color resist', 'Semiconductor photoresist'], processes: ['OPTICAL FILM', 'OLED MATERIAL', 'COLOR FILTER·QD', 'SEMICONDUCTOR PHOTO'], jobs: ['Polymer·Organic chemistry', 'Optical film', 'Device application', 'Quality'], risks: ['디스플레이 사업 재편', '중국 소재 경쟁', '제품별 고객인증'], sources: [{ label: 'Sumitomo ICT & Mobility', url: 'https://www.sumitomo-chem.co.jp/english/products/it_related_chemicals/' }] },
  { id: 'samsung-sdi', name: 'Samsung SDI', country: 'South Korea', category: 'materials', hub: 'materials', status: 'profile', role: 'OLED·편광필름·반도체 전자재료', summary: '배터리와 별도로 OLED 재료·polarizer film, semiconductor SOD·EMC 등 전자재료를 공급하는 대형 공통 소재 노드.', products: ['OLED materials', 'Polarizer film', 'Semiconductor SOD', 'Epoxy molding compound'], processes: ['OLED MATERIAL', 'DISPLAY OPTICAL FILM', 'SEMICONDUCTOR COATING', 'PACKAGE MATERIAL'], jobs: ['Organic·Polymer material', 'Semiconductor material', 'Quality·Application', 'Manufacturing'], risks: ['배터리 사업과 자본배분', '고객·플랫폼 전환', '소재 단가·qualification'], sources: [{ label: 'Samsung SDI 3Q24 IR', url: 'https://www.samsungsdi.com/upload/download/ir/2024.3Q_IR_Final_E.pdf' }] },

  { id: 'icd', name: 'ICD', country: 'South Korea', category: 'equipment', hub: 'materialsEngineering', status: 'profile', role: 'OLED·LCD ICP Dry Etcher', summary: 'AMOLED·LTPS·LTPO·Oxide TFT의 glass pattern 식각과 OLED 증착 전 plasma treatment에 특화된 국내 FPD 전공정 장비기업.', products: ['ICP Dry Etcher', 'Plasma Asher·Treatment', 'Research OLED Evaporator'], processes: ['TFT DRY ETCH', 'ASHING', 'PRE-EVAPORATION TREATMENT', 'OLED R&D'], jobs: ['Plasma process', 'RF·Vacuum', 'Mechanical·Control', 'Field service'], risks: ['패널 고객 CapEx', '중국 장비 내재화', '대면적 균일도·particle'], sources: [{ label: 'ICD ICP Dry Etcher', url: 'https://www.icd.co.kr/business/dry_etcher.html' }, { label: 'ICD OLED Evaporator', url: 'https://www.icd.co.kr/business/ev.html' }] },
  { id: 'hb-solution', name: 'HB Solution', country: 'South Korea', category: 'equipment', hub: 'materialsEngineering', status: 'profile', role: '디스플레이 검사·계측·모듈 장비', summary: 'OLED/LCD 생산의 검사·계측과 module 공정을 중심으로 panel defect 검출과 품질 판정을 지원하는 디스플레이 장비기업.', products: ['Display inspection', 'Measurement equipment', 'Module equipment'], processes: ['PANEL INSPECTION', 'METROLOGY', 'MODULE'], jobs: ['Vision·Algorithm', 'Optics', 'Automation·Control', 'Customer application'], risks: ['검사 투자 변동', '고객·프로젝트 집중', '고해상도 defect 분류 경쟁'], sources: [{ label: 'HB Solution 공식', url: 'https://www.hb-solution.co.kr/' }] },
  { id: 'idemitsu-kosan', name: 'Idemitsu Kosan', country: 'Japan', category: 'materials', hub: 'materials', status: 'profile', role: 'OLED 발광·수송층 재료', summary: 'blue-emitting material을 포함한 OLED 재료의 분자설계·소자평가·양산 공급망을 일본·한국·중국에서 운영한다.', products: ['Blue OLED emitting material', 'OLED host·Transport materials', 'Device optimization'], processes: ['ORGANIC SYNTHESIS', 'OLED EVAPORATION INPUT', 'DEVICE EVALUATION'], jobs: ['Organic molecular design', 'Computational chemistry·AI', 'OLED device', 'Application'], risks: ['blue lifetime·efficiency trade-off', '패널 고객 집중', '특허·차세대 발광 경쟁'], sources: [{ label: 'Idemitsu Electronic Materials', url: 'https://www.idemitsu.com/en/business/denzai/index.html' }, { label: 'Idemitsu OLED R&D', url: 'https://www.idemitsu.com/en/company/rd/electronic/index.html' }] },
  { id: 'nippon-electric-glass', name: 'Nippon Electric Glass', country: 'Japan', category: 'materials', hub: 'materials', status: 'profile', role: 'LCD·OLED·UTG 유리기판', summary: '대형 LCD/OLED부터 LTPS·Oxide TFT, flexible OLED carrier와 ultra-thin cover glass까지 지원하는 디스플레이 유리기업.', products: ['OA-31 LTPS glass', 'OA-20 Oxide/OLED glass', 'OA-11 FPD glass', 'G-Leaf·Dinorex UTG'], processes: ['GLASS FORMING', 'TFT SUBSTRATE', 'FLEXIBLE OLED CARRIER', 'COVER GLASS'], jobs: ['Glass materials', 'Forming·Surface', 'Thermal compaction', 'Quality'], risks: ['패널 수요·판가', '대형 glass 에너지 비용', 'UTG 경쟁'], sources: [{ label: 'NEG Display 제품', url: 'https://www.neg.co.jp/en/products/dp/index.html' }, { label: 'NEG 사업 개요', url: 'https://www.neg.co.jp/en/company/business/index.html' }] },
  { id: 'innox-advanced-materials', name: 'INNOX Advanced Materials', country: 'South Korea', category: 'materials', hub: 'materials', status: 'profile', role: 'OLED 봉지·광학·보호 필름', summary: 'OLED encapsulation film·resin, patterned/protection film, OCA·AR film과 semiconductor package adhesive를 함께 개발하는 국내 IT 소재기업.', products: ['OLED encapsulation film·Resin', 'Patterned·Protection film', 'OCA·AR film', 'Semiconductor package adhesive'], processes: ['OLED ENCAPSULATION', 'MODULE LAMINATION', 'OPTICAL FILM', 'SEMICONDUCTOR PACKAGE'], jobs: ['Adhesive·Polymer', 'Barrier·Optical', 'Reliability', 'Application·Quality'], risks: ['패널 고객집중', '수분·산소 barrier 신뢰성', '원재료·중국 경쟁'], sources: [{ label: 'INNOX 회사·사업 개요', url: 'https://www.innoxamc.com/en/company/intro' }, { label: 'INNOX OLED 소재', url: 'https://www.innoxamc.com/business/productType03?productNo=19&s_code=0331' }] },
