...
export const PROCESS_BENCHMARK_ROWS: ProcessBenchmarkRow[] = [
  ...
  { stage: '전공정', process: '식각', foreignCompanies: ['Lam Research', 'Tokyo Electron', 'Applied Materials'], koreanCompanies: ['DMS', 'APTC', 'SEMES'], domesticTechnology: 85, partsLocalization: 50, mappedCompanyIds: ['lam', 'tel', 'applied-materials', 'semes'] },
  { stage: '전공정', process: '세정', foreignCompanies: ['Tokyo Electron', 'DNS'], koreanCompanies: ['SEMES', 'PSK', 'KC Tech', '제우스', '네오테크놀러지', 'DMS'], domesticTechnology: 85, partsLocalization: 65, mappedCompanyIds: ['tel', 'semes'] },
  ...
  { stage: '전공정', process: '증착', foreignCompanies: ['Applied Materials', 'Tokyo Electron'], koreanCompanies: ['주성엔지니어링', '원익IPS', '유진테크', 'TES', '국제엘렉트릭'], domesticTechnology: 90, partsLocalization: 65, mappedCompanyIds: ['applied-materials', 'tel'] },
  ...
  { stage: '전공정', process: '측정·분석', foreignCompanies: ['KLA-Tencor', 'Applied Materials'], koreanCompanies: ['오로스테크놀로지', 'SFA'], domesticTechnology: 35, partsLocalization: 30, mappedCompanyIds: ['kla', 'applied-materials'] },
